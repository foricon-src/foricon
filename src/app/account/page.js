    ...
    return (
        <div id='sidebar-page'>
            <ul className='btn-list vertical line-active'>
                ...
                <li className={stateActive('security')}>
                ...
                <li className={stateActive('personalization')}>
                ...
                <li className={stateActive('package')}>
                    <f-icon icon='code' i-s='outline'></f-icon><span>Foricon Package</span>
                </li>
            </ul>
            <div>
                <div name='home' className={stateActive()}>
                ...
                <div name='account-info' className={stateActive('info')}>
                    <table>
                        <tr>
                            <td>
                ...
                <div name='account-info/edit' className={stateActive('info/edit')}>
                    <h3>
                        <lang value='en'>Edit account info</lang>
                        <lang value='vi'>Chỉnh sửa thông tin tài khoản</lang>
                        <lang value='fr'>Modifier les informations du compte</lang>
                ...
                <div name='security' className={stateActive('security')}>
                    <h3>
                ...
                <div name='security/change-password' className={stateActive('security/change-password')}>
                    <h3>
                        <lang value='en'>Change password</lang>
                        <lang value='vi'>Thay đổi mật khẩu</lang>
                        <lang value='fr'>Changer le mot de passe</lang>
                ...
                <div name='security/login-history' className={stateActive('security/login-history')}>
                    <h3>
                        <lang value='en'>Login history</lang>
                        <lang value='vi'>Lịch sử đăng nhập</lang>
                        <lang value='fr'>Historique de connexion</lang>
        ...
        for (let i in a) {
            a[i] += '_str'
                ...
                <div name='package' className={stateActive('package')}>
                ...
                <div name='package/settings' className={stateActive('package/settings')}>
                    <h3>
                ...
                <div name='package/download' className={stateActive('package/download')}>
                    <h3>
                        <lang value='en'>Download</lang>
                        <lang value='vi'>Tải xuống</lang>
                        <lang value='fr'>Télécharger</lang>
