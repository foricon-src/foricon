...
export function generateMetadata({ params = { lang: 'en' } }) {
    let { lang } = params;
    let pathname = headers().get('f-pathname');
    ...
    return {
        ...
        description: {
            ...
            ko: 'Foricon은 UI를 빠르게 향상시킬 수 있는 세련되고 맞춤 설정 가능한 아이콘을 제공하는 무료 아이콘 폰트 라이브러리입니다. 전문가 수준의 품질과 사용자 친화적인 디자인으로 모든 프로젝트에 적합합니다.',
